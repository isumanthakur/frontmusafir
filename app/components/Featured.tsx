            ...
            <div className="w-full max-w-7xl flex flex-col md:flex-row justify-between items-center gap-12 md:gap-24 lg:gap-48">
                ...
                <div className="flex flex-col w-full md:w-1/2 gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col text-center md:text-left gap-4 md:gap-5">
                        ...
                        <div className="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4">
                            <span className="text-white bg-emerald-500 px-2 rounded-2xl text-xs font-bold">03</span>
                            <div>
                        ...
                        <Link href="/community">
                            <button className="md:self-start self-center bg-emerald-500 text-white px-6 py-2 rounded-full mt-6 md:ml-8">
                                Start your search
                            </button>
                        </Link>
                    </div>
                ...
                <div className="w-full md:w-1/2 flex justify-center">
                    <video 
                        className="w-full max-w-xs md:max-w-md lg:w-[400px] lg:h-[600px] rounded-3xl object-cover"
                        autoPlay
                        loop
                        muted
                        src="/49.mp4" 
