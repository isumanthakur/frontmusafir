...
const HeroSections: React.FC = () => {
    return (
        <div className="flex flex-col items-center bg-gray-50 justify-center min-h-screen p-8 md:p-48">
            <div className="w-full max-w-7xl flex flex-col md:flex-row justify-between items-center gap-8 md:gap-48">
                ...
                <div className="order-1 md:order-2 flex flex-col w-full md:w-1/2 gap-8">
                    <h1 className="text-4xl font-bold text-center md:text-start text-gray-900">Share your journey</h1>
                    ...
                    <div className="flex md:text-left text-center flex-col gap-5">
                        ...
                        <Link href="/community">
                            <button className="md:self-start self-center bg-teal-400 text-white px-6 py-2 rounded-full mt-8">
                                Community
                            </button>
                        </Link>
                    </div>
